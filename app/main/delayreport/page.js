...
export default function DelayReport() {
  ...
  const dataShow = dataToMap.map((e, index) => {
    ...
    let show = searched.map((e) => (
      <tr className="grid grid-cols-11 border">
        ...
        <td colspan="5" className=" col-span-5 text-start p-2">
          {e.nameEmployee}
        </td>
        <td colspan="5" className=" col-span-5 text-start p-2">
          {e.lates}
        ...
        >
          <thead>
            ...
            <tr className=" grid grid-cols-11  w-full bg-[#8c929450] m-1 text-black/70 border">
              <th className=" col-span-6" colspan="6">
              ...
              <th className=" col-span-5" colspan="5">
                {isArabicprop
            ...
            <tr className="bg-white grid grid-cols-11 border text-black/70">
              ...
              <th colspan="5" className=" col-span-5 text-start p-2">
  ...
  const printDocument = () => {
    ...
    doc.text(90, 10, isArabicprop ? "تقرير التأخير" : "Delay  Report");
    ...
    <div className=" font-sans">
      ...
      <div>
        <Label
          headers={headers}
          data={cvsData}
          fileName="تقارير التأخير "
          pdf={printDocument}
          setsearch={showSearchHandeller}
          label={isArabicprop ? "التأخير" : "Delay"}
        />
      </div>
      {showSearch && (
        <div className=" mb-12">
