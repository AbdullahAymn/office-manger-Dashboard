      ...
      <div className=" font-sans overflow-x-hidden">
        ...
        <div className=" md:p-4 w-full font-sans flex items-center justify-between">
          ...
          <div className=" p-2 grid grid-cols-6 md:flex ">
            ...
            <button
              // onClick={toggelAdd}
              className=" col-span-6  bg-green-400 text-white py-1 px-4 rounded-full md:mx-2 text-md"
            >
              {isArabicprop ? "ترحيل الحركات" : "Transfer Transactions"}{" "}
            </button>
          </div>
        ...
        <div className=" my-10">
          <table className=" min-w-full">
            <thead>
              <tr className="bg-white border text-black/70">
                <th className=" text-start p-2">
                  {isArabicprop
                    ? "الحركات غير المرحلة"
                    : "Not Transferred Transactions"}
                </th>
              </tr>
            </thead>
            <tbody>
              <tr className="bg-gray-200 border text-black/70"></tr>
              <tr className="bg-gray-200 border text-black/70">
                <td className=" text-start p-2">{numberOfUnTransfered}</td>
              </tr>
            </tbody>
          </table>
        </div>
